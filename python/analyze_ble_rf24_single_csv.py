...
def seleccionar_csv() -> Path | None:
    ...
    ruta = filedialog.askopenfilename(
        title="Seleccione el registro del scanner BLE + nRF24L01",
        filetypes=[
            ("Archivos CSV", "*.csv"),
            ("Todos los archivos", "*.*"),
        ],
...
def convertir_columna_numerica(
    ...
    """Convierte texto numérico tolerando comas decimales."""
...
def calcular_limite_escala_rf(
    ...
    """Calcula el límite superior visual del gráfico RF."""
...
def graficar_espectro(
    ...
    """Grafica el último barrido RF."""

    espectro, ultimo_frame = (
        obtener_ultimo_espectro(
            datos_rf
        )
    )
    ...
    if espectro.empty:
        print(
            "No existen datos RF para graficar."
        )
        return
    ...
    # Un único color porque existe un solo nRF24L01.
    plt.bar(
...
# ======================================================================
# FRECUENCIA PARA EL ANÁLISIS TEMPORAL
# ======================================================================
...
def seleccionar_frecuencia_analisis(
    ...
    """
    Usa la frecuencia preferida cuando existe.

    En caso contrario, selecciona la frecuencia con mayor
...
def graficar_deteccion_cruda_filtrada(
    ...
    """Compara la detección cruda con la filtrada."""
...
def construir_identificador_ble(
    ...
    completa o protegida guardada en el CSV.
    """
...
def graficar_rssi(
    ...
    plt.title(
        ...
        "Medición del receptor BLE del ESP32; "
