/*
  ...
  ESCALA AUTOMÁTICA DEL PANEL RF
...
/*
  Límite superior utilizado por el eje vertical RF.

  El valor no es una detección mínima.
  Es solamente el máximo visual actual del gráfico.
*/
float rfDisplayMaximum = 5.0;
...
void updateRFDisplayScale() {
  ...
  /*
    Estas escalas son límites visuales del eje.

    El valor de 5 % no es un umbral del receptor ni significa
    que exista una ocupación mínima de 5 %.
  */
  if (maximumCurrent <= 5) {
    targetMaximum = 5;
  } else if (maximumCurrent <= 10) {
    targetMaximum = 10;
  } else if (maximumCurrent <= 20) {
    targetMaximum = 20;
  } else if (maximumCurrent <= 50) {
    targetMaximum = 50;
  } else {
    targetMaximum = 100;
  }
  ...
  /*
    La escala crece rápidamente cuando aparece actividad alta
    y disminuye lentamente para evitar saltos visuales.
  */
  float alpha =
    targetMaximum >
    rfDisplayMaximum
